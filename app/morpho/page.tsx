  ...
  <div className="min-h-screen max-w-4xl mx-auto px-4 py-5 pb-32 md:pb-6 md:py-10">
    ...
    <div className="text-center mb-8">
        ...
        <p className="text-(--app-foreground-muted) text-lg max-w-2xl mx-auto">
            ...
            <span className="text-(--app-accent) font-semibold"> Network fees paid by $DBRO Team</span>
        </p>
    </div>

    {/* Main Content */}
    <div className="flex items-center justify-center">
        <Earn vaultAddress="0x7BfA7C4f149E7415b73bdeDfe609237e29CBF34A" className="border-gray-800 p-4" isSponsored>
